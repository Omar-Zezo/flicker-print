...
const Filter = ({
  ...
  return (
    <div className="w-[272px] flex flex-col gap-5">
      <h3 className="text-[32px] mb-5 text-black-500 font-medium">
        {t("filter Option")}
      </h3>
      <div
        className={`flex w-full flex-col gap-5 rounded-[18px] py-5 px-3 border border-[#F4F7F9]`}
      >
        <div
          className={`flex justify-between cursor-pointer`}
          onClick={() => setShowSubCategories(!showSubcategories)}
        >
          <h4 className="text-xl text-black-500 font-medium">
            {t("subcategory")}
          </h4>
          <img
            width={40}
        ...
        <form
          className={`flex-col gap-5 h-[400px] overflow-y-auto ${
      ...
      <div className="w-full flex flex-col gap-5 rounded-[18px] py-5 px-3 border border-[#F4F7F9]">
        ...
        >
          <h4 className="text-xl text-black-400 font-medium">
            {t("material")}
          </h4>
          <img
            width={40}
