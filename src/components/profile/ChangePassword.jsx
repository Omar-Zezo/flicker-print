...
const ChangePassword = ({ setShowChangePassword, setVerifyIdentity, langDetection }) => {
      ...
      <div className="py-5 absolute top-1/2 translate-y-[-50%] pt-[70px] left-1/2 translate-x-[-50%] rounded-[25px] bg-white">
        ...
        <div className="size-full px-8 flex flex-col gap-3 items-center justify-center">
          <div className="size-full flex flex-col gap-8">
            <div className="w-[434px] flex flex-col gap-5">
            ...
            >
              <div className="w-[444px] flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    <img
                      width={24}
                      height={21}
                      src={showCurrentPassword ? Eye : EyeDisable}
                ...
                <div className="my-4 text-center text-[12px] font-medium text-black-500">
                  Forgot your password? Don’t worry, click here to send a code
                  to your email. <span className="text-blue-500 cursor-pointer font-semibold underline"
                  onClick={()=>{
